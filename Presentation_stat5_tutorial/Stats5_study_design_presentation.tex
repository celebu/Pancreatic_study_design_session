...
\setbeamertemplate{footline}{% override the footline from Madrid
  ...
  \begin{beamercolorbox}[wd=.333333\paperwidth,ht=8ex,dp=1ex,right]{date in head/foot}%
      \raisebox{-0.5mm}{\includegraphics[height=8ex]{Immagini/Logo_reverse_QMUL}}\hspace*{6ex} \insertframenumber{} \hspace*{2ex} 
  \end{beamercolorbox}}%
  \vskip0pt%
}
\makeatother
...
\titlegraphic{\includegraphics[width=4cm]{Immagini/LogoQM}}
%\logo{\includegraphics[width=.2\textwidth]{Immagini/LogoQM}}
